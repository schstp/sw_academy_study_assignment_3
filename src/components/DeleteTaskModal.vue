...
export default {
  ...
  data: function () {
    return {
      title: 'Вы действительно хотите удалить подзадачу?'
    }
  },
  computed: {
    isVisible: function () {
      return this.$store.state.taskDeletionModalStatus.isInProcess
    }
  },
  methods: {
    closeModal: function () {
      this.$store.state.taskDeletionModalStatus.isInProcess = false
    },
    deleteTask: function () {
